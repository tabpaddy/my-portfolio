            ...
            <div class="home_container container grid">
                <div class="home_content grid">
                    <div class="home_social">
                        ...
                        <a href="https://www.twitter.com/@taborota_p" target="_blank" class="home_social-icon">
                ...
                <!-- portfolio 1 -->
                    <div class="portfolio_content grid image swiper-slide">
                        ...
                        <div class="portfolio_data">
                            ...
                            <a href="http://travelerweb.rf.gd" class="button button_flex button_small portfolio_button" target="blank">
                                Demo
                                <i class="uil uil-arrow-right button_icon"></i>
                            </a>
                        </div>
                    ...
                    <div class="portfolio_content grid image swiper-slide">
                        ...
                        <div class="portfolio_data">
                            ...
                            <p class="portfolio_description">Website adaptable to all devices, with ui components and animated interactions.</p>
                            <a href="http://praisecal.42web.io" class="button button_flex button_small portfolio_button" target="blank">
                                Demo
                                <i class="uil uil-arrow-right button_icon"></i>
                            </a>
                        </div>
